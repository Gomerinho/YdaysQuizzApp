...
if (isset($_POST['envoyer']) && !empty($_POST)) {
    $req = $pdo->prepare("INSERT INTO `quizz` (`id_quizz`, `quizz_name`, `quizz_q1`, `quizz_q1r1`, `quizz_q1r2`, `quizz_q1r3`, `quizz_q1r4`, `quizz_q2`, `quizz_q2r1`, `quizz_q2r2`, `quizz_q2r3`, `quizz_q2r4`, `quizz_q3`, `quizz_q3r1`, `quizz_q3r2`, `quizz_q3r3`, `quizz_q3r4`, `quizz_q4`, `quizz_q4r1`, `quizz_q4r2`, `quizz_q4r3`, `quizz_q4r4`, `quizz_q5`, `quizz_q5r1`, `quizz_q5r2`, `quizz_q5r3`, `quizz_q5r4`, `quizz_q1rb`, `quizz_q2rb`, `quizz_q3rb`, `quizz_q4rb`, `quizz_q5rb`, `id_user`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    $_SESSION['flash']['positive'] = 'Votre quizz à bien été ajoutée ' . $_SESSION['auth']->username;
